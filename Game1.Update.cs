...
public partial class Game1
{
    protected override void Update(GameTime gameTime)
    {
        ...
        if (k.IsKeyDown(Keys.Escape) && !_lastK.IsKeyDown(Keys.Escape))
        {
        ...
        else if (_currentState == GameState.Playing)
        {
            ...
            if (k.IsKeyDown(Keys.W))
            {
                ...
                if (
                    _map[(int)(_playerPos.Y - pRadius), (int)(nx + (dirX > 0 ? pRadius : -pRadius))]
                        == 0
                    && _map[
                        (int)(_playerPos.Y + pRadius),
                        (int)(nx + (dirX > 0 ? pRadius : -pRadius))
                    ] == 0
                )
                    _playerPos.X = nx;

                if (
                    _map[(int)(ny + (dirY > 0 ? pRadius : -pRadius)), (int)(_playerPos.X - pRadius)]
                        == 0
                    && _map[
                        (int)(ny + (dirY > 0 ? pRadius : -pRadius)),
                        (int)(_playerPos.X + pRadius)
                    ] == 0
                )
                    _playerPos.Y = ny;
            }
                ...
                if (monster.IsMelee)
                {
                    ...
                    if (distToPlayer > 0.7f && distToPlayer < 15f)
                    {
                        ...
                        if (Math.Abs(dirToPlayer.X) > 0.001f)
                        {
                            ...
                            if (
                                _map[
                                    (int)(monster.Position.Y - mRadius),
                                    (int)(nx + (dirToPlayer.X > 0 ? mRadius : -mRadius))
                                ] == 0
                                && _map[
                                    (int)(monster.Position.Y + mRadius),
                                    (int)(nx + (dirToPlayer.X > 0 ? mRadius : -mRadius))
                        ...
                        if (Math.Abs(dirToPlayer.Y) > 0.001f)
                        {
                            ...
                            if (
                                _map[
                                    (int)(ny + (dirToPlayer.Y > 0 ? mRadius : -mRadius)),
                                    (int)(monster.Position.X - mRadius)
                                ] == 0
                                && _map[
                                    (int)(ny + (dirToPlayer.Y > 0 ? mRadius : -mRadius)),
                                    (int)(monster.Position.X + mRadius)
